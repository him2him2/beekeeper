...
func (n *Node) UploadBytes(ctx context.Context, b []byte) (err error) {
	r, err := n.api.Bytes.Upload(ctx, bytes.NewReader(b))
	if err != nil {
...
func (n *Node) UploadChunk(ctx context.Context, c swarm.Chunk) (err error) {
